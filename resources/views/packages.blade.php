                      ...
                      <table class="table align-middle table-row-dashed gy-5"
                                                  ...
                                                  <tbody class="fs-6 fw-bold text-gray-600">
                                                      ...
                                                      <tr>
                                                          ...
                                                          <td class="text-end">
                                                              <a href="<?php echo url('/upravitprogram/'.$p->id);?>" class="btn btn-light btn-sm btn-active-light-primary mytablecss">Upraviť</a>
                                                          </td>
                                                      </tr>
                                                      @endforeach
                                                  </tbody>
                ...
                <div class="savemodal" id="successModal">
   											 <div class="savemodal-content">
   												 <div class="swal2-icon swal2-success swal2-icon-show" style="display: flex;"><div class="swal2-success-circular-line-left" style="background-color: rgb(255, 255, 255);"></div>
   													...
   													<div class="swal2-html-container mt-8" id="swal2-html-container" style="display: block;">Zákazníkovi sa priraďuje program!</div>
   											 </div>
   									 </div>
