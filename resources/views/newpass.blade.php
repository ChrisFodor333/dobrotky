...
<br> <br>
					...
					<div class="w-lg-500px bg-body rounded shadow-sm p-10 p-lg-15 mx-auto">
						<!--begin::Form-->
						<form class="form w-100" novalidate="novalidate" action="{{ url('/reset_password_with_token_customer') }}" method="post">
							<!--begin::Heading-->
							<div class="text-center mb-10">
								<!--begin::Title-->
								<h1 class="text-dark mb-3">Nastaviť nové heslo</h1>
								<!--end::Title-->
								<!--begin::Link-->
							...
							<div class="fv-row mb-10">
								<!--begin::Label-->
								<label class="form-label fs-6 fw-bolder text-dark">Nové heslo</label>
								<!--end::Label-->
								<!--begin::Input-->
								<input class="form-control form-control-lg form-control-solid" value="" required type="password" name="password" autocomplete="off" />
								<!--end::Input-->
							</div>
							<!--end::Input group-->
							<!--begin::Input group-->
							<div class="fv-row mb-10">
								...
								<div class="d-flex flex-stack mb-2">
									<!--begin::Label-->
									<label class="form-label fw-bolder text-dark fs-6 mb-0">Nové heslo znovu</label>
									<!--end::Label-->
									<!--begin::Link-->
								...
								<input class="form-control form-control-lg form-control-solid" type="password" required name="password_confirmation"  autocomplete="off" />
								<!--end::Input-->
							</div>
							<!--end::Input group-->
							<!--begin::Actions-->
							<div class="text-center">
								...
								<button type="submit" name="submit" value="submit" class="btn btn-lg btn-primary w-100 mb-5">
								<span class="indicator-label">Nastaviť heslo</span>
								</button>
								<!--end::Submit button-->
								<!--begin::Separator-->
		...
		<!--end::Main-->
		<!--begin::Javascript-->
		<script>var hostUrl = "<?php echo url('/');?>/assets/metronic/dist/assets/";</script>
