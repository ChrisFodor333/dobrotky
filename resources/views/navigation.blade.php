					...
					<div class="aside-menu flex-column-fluid">
						...
						<div class="hover-scroll-overlay-y my-5 my-lg-5" id="kt_aside_menu_wrapper" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_aside_logo, #kt_aside_footer" data-kt-scroll-wrappers="#kt_aside_menu" data-kt-scroll-offset="0">
							...
							<div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_aside_menu" data-kt-menu="true" data-kt-menu-expand="false">
								...
								<div class="menu-item">
          			<a class="menu-link" href="<?php echo url('/zakaznici');?>" data-bs-trigger="hover" data-bs-dismiss="click" data-bs-placement="right">
            		<span class="menu-icon">
            ...
            <span class="menu-title">Zákazníci</span>
          </a>
        </div>


	<div class="menu-item">
			<a class="menu-link" href="<?php echo url('/menu');?>" data-bs-trigger="hover" data-bs-dismiss="click" data-bs-placement="right">
			<span class="menu-icon">
		<!--begin::Svg Icon | path: icons/duotune/general/gen019.svg-->
		<span class="svg-icon svg-icon-2">
											<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
	...
	<span class="menu-title">Nahrať Menu</span>
</a>
</div>


				<div class="menu-item menu-accordion">
          <a href="<?php echo url('/admins');?>">
          <span class="menu-link">
            <span class="menu-icon">
        ...
        <span class="menu-title">Správcovia</span>
          </span>
          </a>
        </div>
            ...
            <span class="menu-title">Odhlásiť sa</span>
          </a>
        </div>
