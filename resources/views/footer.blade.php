...
<!-- Loading Modal -->
<div class="modal fade" id="loadingModal" tabindex="-1" role="dialog" aria-labelledby="loadingModalLabel" aria-hidden="true" style="z-index: 3050;">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-body d-flex align-items-center">
                ...
                <h3 style="margin-left: 18px !important;">Prosím počkajte</h3>
            </div>
        </div>
    </div>
</div>
...
<script src="<?php echo url('/');?>/assets/js/custom/utilities/modals/offer-a-deal/type.js"></script>
<script src="<?php echo url('/');?>/assets/js/custom/utilities/modals/offer-a-deal/details.js"></script>
<script src="<?php echo url('/');?>/assets/js/custom/utilities/modals/offer-a-deal/finance.js"></script>
<script src="<?php echo url('/');?>/assets/js/custom/utilities/modals/offer-a-deal/complete.js"></script>
<script src="<?php echo url('/');?>/assets/js/custom/utilities/modals/offer-a-deal/main.js"></script>
...
<script src="<?php echo url('/');?>/assets/plugins/custom/datatables/datatables.bundle.js"></script>
<script src="<?php echo url('/');?>/assets/js/custom/apps/subscriptions/list/export.js"></script>
<script src="<?php echo url('/');?>/assets/js/custom/apps/subscriptions/list/list.js"></script>
<script src="<?php echo url('/');?>/assets/js/widgets.bundle.js"></script>
<script src="<?php echo url('/');?>/assets/js/custom/widgets.js"></script>
