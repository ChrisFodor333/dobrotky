...
<br> <br>
					...
					<div class="w-lg-500px bg-body rounded shadow-sm p-10 p-lg-15 mx-auto">
						<!--begin::Form-->
						<form class="form w-100" novalidate="novalidate" action="{{ url('/reset_password_with_token') }}" method="post">
							<!--begin::Heading-->
							<div class="text-center mb-10">
								<!--begin::Title-->
								<h1 class="text-dark mb-3">Resetovať heslo</h1>
								<!--end::Title-->
								<!--begin::Link-->
							...
							<div class="text-center">
								...
								<span class="indicator-label">Resetovať heslo</span>
								</button>
								<!--end::Submit button-->
								<!--begin::Separator-->
